    ...
    try:
        ...
        for mapping_name in mappings:
            try:
                ...
                frappe.log_error(f"Error processing mapping {mapping_name}: {str(e)[:100]}", "BPJS Mapping Update Error")
    except Exception as e:
        frappe.log_error(f"Error updating BPJS mappings: {str(e)[:100]}", "BPJS Mapping Update Error")