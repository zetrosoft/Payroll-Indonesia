...
def get_bpjs_settings() -> Dict[str, Any]:
    ...
    return {
        ...
        "jkk": {"percent": flt(settings_doc.get("jkk_percent", 0.24))},
        "jkm": {"percent": flt(settings_doc.get("jkm_percent", 0.3))},
    }
...
def get_ptkp_settings() -> Dict[str, float]:
    ...
    try:
        ...
        frappe.log_error(
            f"Error retrieving PTKP settings from DocType: {str(e)}", "PTKP Settings Error"
        )
...
def get_spt_month() -> int:
    ...
    try:
        ...
        settings_doc = _get_payroll_settings(
            "Payroll Indonesia Settings", "payroll_indonesia_settings", {}
        )
...
def create_parent_liability_account(company: str) -> Optional[str]:
    ...
    try:
        ...
        settings = _get_payroll_settings(
            "Payroll Indonesia Settings", "payroll_indonesia_settings", {}
        )
